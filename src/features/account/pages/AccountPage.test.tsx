...
const session = { addr: "127.0.0.1:19091", principalId: "prn_alice", username: "alice" };
...
test("renders current principal session and access summary", () => {
  ...
  expect(screen.getByRole("link", { name: /open accessible spaces/i })).toHaveAttribute("href", "/spaces");
});
    ...
    <MemoryRouter>
      <AccountPage
        ...
        principalContext={{
          ...
          roles: [],
          capabilities: [],
          capabilityState: { kind: "unknown", warnings: ["Capabilities unavailable"] },
