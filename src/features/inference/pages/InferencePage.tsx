...
const inferenceOperations = ["chat", "embeddings", "summarize", "classify"];
      ...
      try {
        if (activeTab === "endpoints") {
          ...
          const [modelsResponse, capabilitiesResponse] = await Promise.all([
            listModelsService({ pageSize: 100, operation: operationFilter }),
